    ...
    try {
        ...
        if (!shouldDoCampusSearch) {
            ...
            try {
                ...
                // Fire-and-forget: record session asynchronously
                (async () => {
                    try {
                        ...
                        console.error("background log error (direct gemini):", err);
                    }
                })();
        ...
        // Continue with existing campus search logic (RAG + classification)
